...
<?php } else { ?>
  <h3 class="titulo">Selecciona el empleado<hr></h3>
  	  ...
  	  <div class="panel-body">
  	  	<div class="row">
               ...
               <select name="empleado" class="form-control">
                   <?php while($row = mysqli_fetch_array($data['empleados'])) { ?>
                   <option value="<?php echo $row['id_empleado']; ?>"><?php echo $row['nombre']." ".$row['paterno']." ".$row['materno']; ?></option>
                   <?php } ?>
               </select><br>
